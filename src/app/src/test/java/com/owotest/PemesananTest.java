...
public class PemesananTest {
    ...
    private final TiketPesawat tiket = new TiketPesawat(1, 100000.0f, true, "GA123", "Jakarta", "Bali", "Garuda Indonesia");
    ...
    void testSetAndGetTiket() {
        TiketPesawat newTiket = new TiketPesawat(2, 200000.0f, true, "GA124", "Bali", "Jakarta", "Garuda Indonesia");
